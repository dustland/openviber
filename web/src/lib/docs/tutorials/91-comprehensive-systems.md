...
async function main() {
  console.log("\n" + "═".repeat(50));
  console.log("🔬 Viber Research Assistant");
  console.log("═".repeat(50));
...
async function main() {
  console.log("\n🔬 Viber Research Assistant - Quick Demo\n");
...
- [React Integration](/sdk/react) — Build web UIs
- [Example Projects](https://github.com/dustland/viber/tree/main/examples) — More examples
