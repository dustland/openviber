    ...
    <div class="max-w-4xl mx-auto">
        <header class="mb-8">
            ...
            <p class="text-muted-foreground">
                Automated tasks that run on a schedule. Jobs are defined as YAML
                files in
