...
flowchart TB
    subgraph Pillars["Three Pillars"]
        Jobs["📅 Jobs<br/>Scheduled YAML cron tasks"]
        Skills["🔧 Skills<br/>SKILL.md capabilities"]
        Tools["⚙️ Tools<br/>Low-level primitives"]
    end
...
flowchart LR
    ...
    ViberAgent --> Planning["📋 Plan Creation"]
    Planning --> Delegation["👥 Agent Delegation"]
    Delegation --> Tools["🔧 Tool Execution"]
    Tools --> Result["✅ Result"]
    Result --> User
```
...
flowchart TB
    ...
    subgraph Viber["🖥️ Viber Cowork Desktop"]
...
flowchart TB
    ...
    Decision -->|Yes| Pause["⏸️ Pause for Approval"]
...
```mermaid
flowchart LR
    YAML["📄 YAML Job"] --> Scheduler["⏰ Scheduler"]
...
- [Desktop Tools](/docs/design/desktop-tools) — GUI automation with browser control
  - [Tool Execution](/docs/design/tool-execution) — Tool system design

  - [Task Lifecycle](/docs/design/task-lifecycle) — How tasks are executed

  - [Philosophy](/docs/design/philosophy) — Design principles and vision
